  ...
  return (
    <section className="mt-16 pt-10 border-t border-[#E1E1E1] dark:border-[#2C2C30]">
      <BlurFade delay={0.1} yOffset={16}>
        ...
        <div className="bg-white dark:bg-[#222225] p-6 rounded-2xl border border-[#E1E1E1] dark:border-[#2C2C30] mb-10 shadow-xs">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-sans text-[#4C586F] dark:text-[#A0A9B8] mb-1">
                  Your Name *
                </label>
                <input
                  type="text"
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-medium bg-[#1C1C1E] dark:bg-white text-white dark:text-[#1C1C1E] rounded-xl hover:opacity-90 transition-opacity cursor-pointer shadow-xs"
              >
        ...
        <div className="space-y-4">
          {comments.map((comment) => (
            <div
              key={comment.id}
              className="p-5 rounded-2xl bg-white dark:bg-[#222225] border border-[#E1E1E1] dark:border-[#2C2C30] shadow-xs space-y-3"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img
                    src={comment.avatar}
                    alt={comment.name}
                    className="w-9 h-9 rounded-full object-cover bg-[#E8E7E2]"
                  />
                  <div>
